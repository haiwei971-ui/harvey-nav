...
export const SITES = [
  ...
  // ✅ Claude: Changed to use claude-color.svg primarily
  ...
  // ✅ Gemini: gemini.svg removed from icons array to prevent overlap with the special gemini logic
  { n:"Gemini",       u:"https://gemini.google.com/",     icons:[],                       c:"#4e85ff", r:1, whiteInvert:true, gemini:true, s:1.14 },
  // ✅ Cloudflare: Changed to use cloudflare-color.svg
